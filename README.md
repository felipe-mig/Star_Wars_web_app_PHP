...
- ✨This is a Star Wars - Original Trilogy Web App built in PHP and JavaScript. There is a public view and a private view where the user can CREATE, UPDATE and DELETE records.
