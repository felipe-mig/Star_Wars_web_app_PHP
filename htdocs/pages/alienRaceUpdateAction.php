...
updateAlien($dbConnect, $id, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);

$updateAlien = updateAlien($dbConnect, $id, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body>
    ...
    <script>
        function bounce(){
            window.location.href = "alienRacesPrivateSide.php"
        }
