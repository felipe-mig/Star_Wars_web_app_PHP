    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="addContainer">
                    <a href="movieAddNew.php"><i class="fa-solid fa-circle-plus" id="iconAdd"></i></a>
                </div>  

                <div class="dataDisplayMainContainer" style=" width: 62%;">

                    <?php listMoviePrivateSide($dbConnect) ?>
