...
$thumbernail = returnCharacterDetails($dbConnect, $id, 'thumbernail');
...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <form class="formDetailsMainContainer" action="characterUpdateAction.php" method="POST">
                    <div class="updateSlideshowContainer">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">

                        <div class="updateImageThumbernailContainer">
                            <img class="updateImageThumbernail" src="../images/characters/<?php echo $thumbernail; ?>" alt="thumbernail">
                        ...
                        <div class="updateImageSlideOneContainer">
                            <img class="updateImageSlideOne" src="../images/characters/<?php echo $imageone; ?>" alt="image1">
                        ...
                        <div class="updateImageSlideTwoContainer">
                            <img class="updateImageSlideTwo" src="../images/characters/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <div class="updateConfirmButtonsContainer">
                        <a href="charactersPrivateSide.php"><div class="updateCancelButton">Cancel</div></a>
