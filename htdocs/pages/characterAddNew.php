...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
            ...
            <form class="addCharacterForm" action="characterAddNewAction.php" method="post">
                ...
                <a href="dashboard.php"><div class="addNewFormLogo"></div></a>
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\characters </span><br> Should have no background (png or webp)</label>
