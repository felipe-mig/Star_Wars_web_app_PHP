    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="addContainer">
                    <a href="jediAddNew.php"><i class="fa-solid fa-circle-plus" id="iconAdd"></i></a>
                    ...
                    <div class="dropdownContainerPrivate" style="z-index: 3;">
                        <ul>
                            <li>
                                ...
                                <ul>
                                <?php jedisSortByDropdownPrivate() ?>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- Search Bar -->
                <form class="searchBarPrivate" action="jedisPrivateSideSearchByName.php" method="GET">
                    <i class="fa-solid fa-magnifying-glass" id="searchIcon"></i>
                    <input type="text" name="keyword" class="searchInput" placeholder="Search Jedi...." required <?php echo "value=$keyword "; ?> >
                </form>
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchJediPrivateSide($dbConnect, $keyword, $succesfullSearch) ?>
