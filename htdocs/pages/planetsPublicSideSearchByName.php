...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="dropdownContainer">
                    <ul>
                        <li>
                            ...
                            <ul>
                                <?php planetsSortByDropdownPublic() ?>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <!-- Search Bar -->
                <form class="searchBar" action="planetsPublicSideSearchByName.php" method="GET">
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchPlanetPublicSide($dbConnect, $keyword, $succesfullSearch)?>
