    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="addContainer">
                    <a href="planetAddNew.php"><i class="fa-solid fa-circle-plus" id="iconAdd"></i></a>
                    ...
                    <div class="dropdownContainerPrivate" style="z-index: 3;">
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <?php planetsSortByDropdownPrivate() ?>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- Search Bar -->
                <form class="searchBarPrivate" action="planetsPrivateSideSearchByName.php" method="GET">
                    <i class="fa-solid fa-magnifying-glass" id="searchIcon"></i>
                    <input type="text" name="keyword" class="searchInput" placeholder="Search Planet...." required <?php echo "value=$keyword "; ?> >
                </form>


                <div class="dataDisplayMainContainer">

                    <?php searchPlanetPrivateSide($dbConnect, $keyword, $succesfullSearch) ?>
