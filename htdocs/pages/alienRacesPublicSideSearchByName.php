    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
               ...
               <!-- Dropdown -->
                <div class="dropdownContainer">
                    <ul>
                        <li>
                            ...
                            <ul>
                                <?php alienRacesSortByDropdownPublic() ?>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <!-- Search Bar -->
                <form class="searchBar" action="alienRacesPublicSideSearchByName.php" method="GET">
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchAlienRacePublicSide($dbConnect, $keyword, $succesfullSearch); ?>
