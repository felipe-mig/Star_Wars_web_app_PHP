    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                <!-- section header -->
                 <!-- MOVIES -->
                <br>
                <div class="sectionTitleContainerMovies">
                    <div class="moviesGradientUnderlineLeft"></div>
                    <h3 class="moviesH3">Movies</h3>
                    <div class="moviesGradientUnderlineRight"></div>
                </div>

                <div class="moviesMainContainer">
                    
                    <?php listMoviePublicSide($dbConnect) ?>
