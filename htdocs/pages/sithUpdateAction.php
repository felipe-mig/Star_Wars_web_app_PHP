...
updateSith($dbConnect, $id, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);

$updateSith = updateSith($dbConnect, $id, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body>
    ...
    <script>
        function bounce(){
            window.location.href = "sithsPrivateSide.php"
        }
