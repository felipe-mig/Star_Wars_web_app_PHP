...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
            ...
            <form class="addCharacterForm" action="sithAddNewAction.php" method="post">

                <a href="dashboard.php"><div class="addNewFormLogo" style="background-image: url(../images/logo/vader.png); height: 15vh"></div></a>
                ...
                <div class="sithlighSabersContainerLogin">
                        ...
                        <div class="sithLightSaberLeftPart2Login"></div>
                        <!-- <div class="sithLightSabeRightPart2Login"></div>
                        <div class="sithLightSaberRightPart1Login"></div> -->
                </div>
                <br>
                <br>
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\siths </span></label>
