...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
            ...
            <form class="addCharacterForm" action="shipAddNewAction.php" method="post">
                ...
                <a href="dashboard.php"><div class="addNewFormLogo" style="background-image: url(../images/logo/millenium.png)"></div></a>

                <label class="regularLabel">name:</label>
                <input class="inputRegular" type="text" name="name" required/>
                <br>

                <label class="regularLabel">affiliation:</label>
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\ships </span><br> Should have no background (png or webp)</label>
                <!-- <input class="inputRegular" type="text" name="thumbernail" required placeholder="image.png"> -->
                <select name="thumbernail" >
                    <option value="" disabled selected hidden>Select</option>
                    <?php
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\ships </span></label>
