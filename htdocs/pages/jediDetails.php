        ...
        <div class="mainRightContainer">
                ...
                <div class="detailsMainContainer">
                    <div class="slideshowContainer">
                        <img class="imageSlides" src="../images/jedis/<?php echo $imageone; ?>" alt="image1">
                        <img class="imageSlides" src="../images/jedis/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <?php if ($lightsaber){
                        echo '
                            ...
                            <div class="lightSaber'.$lightsaber.'LeftPart2JediForm" style="background-color: '.$lightsaber.';   box-shadow: 0px 0px 10px '.$lightsaber.';"></div>
                        ';
                        } 
                    ?>
