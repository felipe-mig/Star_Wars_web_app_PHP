...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <!-- Search Bar -->
                <form class="searchBar" action="shipsPublicSideSearchByName.php" method="GET">
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchShipPublicSide($dbConnect, $keyword, $succesfullSearch) ?>
