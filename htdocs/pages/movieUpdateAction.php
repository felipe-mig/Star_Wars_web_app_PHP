...
updateMovie($dbConnect, $id, $title, $intro, $sypnosis, $posterimage, $background, $imageone, $imagetwo);

$updateMovie = updateMovie($dbConnect, $id, $title, $intro, $sypnosis, $posterimage, $background, $imageone, $imagetwo)
...
<body>
            ...
            <?php if ($updateMovie){ 
                ...
                echo '   
                    <div class="UpdateSuccessMessageContainer">
                        ...
                        <p class="updateSuccesP">'.$title.' has been succesfully updated</p>
                    </div>
                ';
            } 
    ...
    <script>
        function bounce(){
            window.location.href = "moviesPrivateSide.php"
        }
