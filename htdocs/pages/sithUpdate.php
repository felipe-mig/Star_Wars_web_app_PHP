...
$id = $_GET['id'];
$name = returnSithDetails($dbConnect, $id, 'name');
$bio = returnSithDetails($dbConnect, $id, 'bio');
$episodeiv = returnSithDetails($dbConnect, $id, 'episodeiv');
$episodev = returnSithDetails($dbConnect, $id, 'episodev');
$episodevi = returnSithDetails($dbConnect, $id, 'episodevi');
$thumbernail = returnSithDetails($dbConnect, $id, 'thumbernail');
$imageone = returnSithDetails($dbConnect, $id, 'imageone');
$imagetwo = returnSithDetails($dbConnect, $id, 'imagetwo');
...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <form class="formDetailsMainContainer" action="sithUpdateAction.php" method="POST">
                    <div class="updateSlideshowContainer">
                        <input type="hidden" name="id" value="<?php echo $id ?>">

                        <div class="updateImageThumbernailContainer">
                            <img class="updateImageThumbernail" src="../images/siths/<?php echo $thumbernail; ?>" alt="thumbernail">
                        ...
                        <div class="updateImageSlideOneContainer">
                            <img class="updateImageSlideOne" src="../images/siths/<?php echo $imageone; ?>" alt="image1">
                        ...
                        <div class="updateImageSlideTwoContainer">
                            <img class="updateImageSlideTwo" src="../images/siths/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <div class="updateConfirmButtonsContainer">
                        <a href="sithsPrivateSide.php"><div class="updateCancelButton">Cancel</div></a>
