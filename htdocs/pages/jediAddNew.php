...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
            ...
            <form class="addCharacterForm" action="jediAddNewAction.php" method="post">
                <a href="dashboard.php"><div class="addNewFormLogo" style="background-image: url(../images/logo/yoda2.png)"></div></a>

                <label class="regularLabel">name:</label>
                <input class="inputRegular" type="text" name="name" required/>
                <br>
                <label class="regularLabel">light saber:</label>   

                <div class="radioButtonContainer">

                    <input  type="radio" name="lightsaber" value="blue">
                    ...
                    <input  type="radio" name="lightsaber" value="green">
                    <label class="labelCheckbox">
                        <div class="lightSaberLeftPart1JediForm"></div>
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\jedis </span><br> Should have no background (png or webp)</label>
                <select name="thumbernail" id="filesthumber" required>
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\characters </span></label>
                ...
                <label class="smallLabel"> To add new images follow this path: <br> <span style="font-style: italic;">htdocs\images\characters </span></label>
                <select name="imagetwo" id="files2">
                    <option value="" disabled selected hidden>Select</option>
                    <?php
                        foreach ($files as $file) {
                            // Skip current and parent directory 
