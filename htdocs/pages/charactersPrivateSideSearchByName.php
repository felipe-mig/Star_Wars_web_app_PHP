    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="addContainer">
                    <a href="characterAddNew.php"><i class="fa-solid fa-circle-plus" id="iconAdd"></i></a>

                    <!-- Dropdown -->
                    <div class="dropdownContainerPrivate" style="z-index: 3;">
                        <ul>
                            <li>
                                <a href="#iconAdd"><i class="fa fa-sort" id="iconSort"></i>Sort by</a>
                                <ul>
                                <?php charactersSortByDropdownPrivate() ?>
                                </ul>
                            </li>
                        </ul>
                    </div>
                 ...
                 <!-- Search Bar -->
                 <form class="searchBarPrivate" action="charactersPrivateSideSearchByName.php" method="GET">
                    <i class="fa-solid fa-magnifying-glass" id="searchIcon"></i>
                    <input type="text" name="keyword" class="searchInput" placeholder="Search Character...." required <?php echo "value=$keyword "; ?> >
                </form>

                <div class="dataDisplayMainContainer">

                    <?php echo '<p class="searchResultsP">Search results for <strong style="color: rgba(255, 255, 255, 0.9);">"'.$keyword.'"</strong> </p> '; ?>

                    <?php searchCharacterPrivateSide($dbConnect, $keyword, $succesfullSearch)?>
