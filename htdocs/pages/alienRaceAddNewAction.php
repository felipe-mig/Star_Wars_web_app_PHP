...
$insertAlien = insertAlien($dbConnect, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body onload="bounce()">
    ...
    <script>
        ...
        function bounce(){
            window.location.href = "alienRacesPrivateSide.php#iconAdd"
        }
