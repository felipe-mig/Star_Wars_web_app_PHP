    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="dropdownContainer">
                    <ul>
                        <li>
                            ...
                            <ul>
                                <?php charactersSortByDropdownPublic() ?>
                            </ul>
                        </li>
                    </ul>
                </div>
                 ...
                 <!-- Search Bar -->
                 <form class="searchBar" action="charactersPublicSideSearchByName.php" method="GET">
                ...
                <div class="dataDisplayMainContainer">
                    <?php
                    echo '
                         <p class="searchResultsP">Search results for <strong style="color: rgba(255, 255, 255, 0.9);">"'.$keyword.'"</strong> </p>
                    ';
                    ?>

                    <?php searchCharacterPublicSide($dbConnect, $keyword, $succesfullSearch); ?>
