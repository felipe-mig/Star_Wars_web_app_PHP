...
<head>
    ...
    <style>
        ...
        .dataCardContainer:hover .cardImg {filter:drop-shadow(0px 0px 25px rgb(255, 0, 0));}
        .dataCardContainer:hover {cursor:pointer; border:2px solid rgba(255, 255, 255, 0.8); background-color:rgba(0, 0, 0, 0.6); transform:scale(1.03); -moz-transform:scale(1.03); -webkit-transform:scale(1.03); -o-transform:scale(1.03); -ms-transform:scale(1.03); transition:all 0.3s ease-in-out; -moz-transition:all 0.3s ease-in-out; -webkit-transition:all 0.3s ease-in-out; -o-transition:all 0.3s ease-in-out; -ms-transition:all 0.3s ease-in-out; box-shadow:0px 0px 15px red;}
...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <!-- Search Bar -->
                <form class="searchBar" action="sithsPublicSideSearchByName.php" method="GET">
                    <i class="fa-solid fa-magnifying-glass" id="searchIcon"></i>
                    <input type="text" name="keyword" class="searchInput" placeholder="Search Sith...." required <?php echo "value=$keyword "; ?> >
                </form>   

                <div class="dataDisplayMainContainer">

                    <?php searchSithPublicSide($dbConnect, $keyword, $succesfullSearch); ?>
