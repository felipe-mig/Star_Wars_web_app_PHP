...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainerAbout">
                ...
                <div class="star-wars">
                    ...
                    <div class="crawl" id="crawl">
                        ...
                        <br>
                        <p> It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first victory against the evil Galactic Empire. During the battle, Rebel spies managed to steal secret plans to the Empire's ultimate weapon, the DEATHSTAR, an armored space station with enough power to destroy an entire planet. </p>
        ...
        <div class="aboutMobileContainer">
            ...
            <br><br><br>
            <p class="crawlingMobile">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora fugiat amet debitis officia? Id voluptatibus dolorum dicta? Rerum labore itaque possimus ratione vero explicabo voluptate eveniet ad fugit exercitationem? Nemo.</p>
        </div>
