...
updateShip($dbConnect, $id, $name, $affiliation, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);

$updateShip =  updateShip($dbConnect, $id, $name, $affiliation, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body>
    ...
    <script>
        function bounce(){
            window.location.href = "shipsPrivateSide.php"
        }
