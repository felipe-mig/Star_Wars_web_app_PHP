...
updateCharacter($dbConnect, $id, $name, $affiliation, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);

$updateCharacter =  updateCharacter($dbConnect, $id, $name, $affiliation, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body>
    ...
    <script>
        function bounce(){
            window.location.href = "charactersPrivateSide.php"
        }
