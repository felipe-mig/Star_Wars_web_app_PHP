...
$id = $_GET['id'];
$name = returnPlanetDetails($dbConnect, $id, 'name');
$bio = returnPlanetDetails($dbConnect, $id, 'bio');
$episodeiv = returnPlanetDetails($dbConnect, $id, 'episodeiv');
$episodev = returnPlanetDetails($dbConnect, $id, 'episodev');
$episodevi = returnPlanetDetails($dbConnect, $id, 'episodevi');
$thumbernail = returnPlanetDetails($dbConnect, $id, 'thumbernail');
$imageone = returnPlanetDetails($dbConnect, $id, 'imageone');
$imagetwo = returnPlanetDetails($dbConnect, $id, 'imagetwo');
...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <form class="formDetailsMainContainer" action="planetUpdateAction.php" method="POST">
                    <div class="updateSlideshowContainer">
                        <input type="hidden" name="id" value="<?php echo $id ?>">

                        <div class="updateImageThumbernailContainer">
                            <img class="updateImageThumbernail" src="../images/planets/<?php echo $thumbernail; ?>" alt="thumbernail">
                        ...
                        <div class="updateImageSlideOneContainer">
                            <img class="updateImageSlideOne" src="../images/planets/<?php echo $imageone; ?>" alt="image1">
                        ...
                        <div class="updateImageSlideTwoContainer">
                            <img class="updateImageSlideTwo" src="../images/planets/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <div class="updateConfirmButtonsContainer">
                        <a href="planetsPrivateSide.php"><div class="updateCancelButton">Cancel</div></a>
