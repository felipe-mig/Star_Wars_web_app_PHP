        ...
        <div class="mainRightContainer">
                ...
                <div class="detailsMainContainer">
                    <div class="slideshowContainer">
                        <img class="imageSlides" src="../images/siths/<?php echo $imageone; ?>" alt="image1">
                        <img class="imageSlides" src="../images/siths/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <h6 class="extraDetailsHeader">Light Saber:</h6>
                    <br>
                    <div class="sithlighSabersContainerLogin">
                        <div class="sithLightSaberLeftPart1Login"></div>
                        <div class="sithLightSaberLeftPart2Login" style="  background-color: #ff0000;   box-shadow: 0px 0px 10px #ff0000;"></div>
                    </div>
