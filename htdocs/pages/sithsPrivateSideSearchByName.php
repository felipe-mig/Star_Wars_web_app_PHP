    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="addContainer">
                    <a href="sithAddNew.php"><i class="fa-solid fa-circle-plus" id="iconAdd"></i></a>
                    ...
                    <div class="dropdownContainerPrivate" style="z-index: 3;">
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <?php sithsSortByDropdownPrivate() ?>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- Search Bar -->
                <form class="searchBarPrivate" action="sithsPrivateSideSearchByName.php" method="GET">
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchSithPrivateSide($dbConnect, $keyword, $succesfullSearch) ?>
