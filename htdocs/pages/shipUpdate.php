...
$id = $_GET['id'];
$name = returnShipDetails($dbConnect, $id, 'name');
$affiliation = returnShipDetails($dbConnect, $id, 'affiliation');
$bio = returnShipDetails($dbConnect, $id, 'bio');
$episodeiv = returnShipDetails($dbConnect, $id, 'episodeiv');
$episodev = returnShipDetails($dbConnect, $id, 'episodev');
$episodevi = returnShipDetails($dbConnect, $id, 'episodevi');
$thumbernail = returnShipDetails($dbConnect, $id, 'thumbernail');
$imageone = returnShipDetails($dbConnect, $id, 'imageone');
$imagetwo = returnShipDetails($dbConnect, $id, 'imagetwo');
...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <form class="formDetailsMainContainer" action="shipUpdateAction.php" method="POST">
                    <div class="updateSlideshowContainer">
                        <input type="hidden" name="id" value="<?php echo $id ?>">

                        <div class="updateImageThumbernailContainer">
                            <img class="updateImageThumbernail" src="../images/ships/<?php echo $thumbernail; ?>" alt="thumbernail">
                        ...
                        <div class="updateImageSlideOneContainer">
                            <img class="updateImageSlideOne" src="../images/ships/<?php echo $imageone; ?>" alt="image1">
                        ...
                        <div class="updateImageSlideTwoContainer">
                            <img class="updateImageSlideTwo" src="../images/ships/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <div class="affilliationsContainer">
                        ...
                        <br>
                        <select class="updateAffilition" name="affiliation">
                        <!-- control programming for affiliation dropdown  -->

                            <option value="" disabled selected hidden>Select</option>
                            <option value="Rebel Alliance" <?php if ($affiliation === "Rebel Alliance") { echo 'selected'; } ?> >Rebel Alliance</option>
                            <option value="Galactic Empire" <?php if ($affiliation === "Galactic Empire") { echo 'selected'; } ?> >Galactic Empire</option>
                            <option value="none" <?php if ($affiliation === "none") { echo 'selected'; } ?> >none</option>
                    ...
                    <div class="updateConfirmButtonsContainer">
                        <a href="shipsPrivateSide.php"><div class="updateCancelButton">Cancel</div></a>
