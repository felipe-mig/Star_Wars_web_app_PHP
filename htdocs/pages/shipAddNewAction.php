...
$insertShip = insertShip($dbConnect, $name, $affiliation, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body onload="bounce()">
    ...
    <script>
        ...
        function bounce(){
            window.location.href = "shipsPrivateSide.php#iconAdd"
        }
