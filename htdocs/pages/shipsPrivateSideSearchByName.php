    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <div class="addContainer">
                    <a href="shipAddNew.php"><i class="fa-solid fa-circle-plus" id="iconAdd"></i></a>
                    ...
                    <div class="dropdownContainerPrivate" style="z-index: 3;">
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <?php shipsSortByDropdownPrivate() ?>
                                </ul>
                            </li>
                        </ul>
                    </div>
                 ...
                 <!-- Search Bar -->
                 <form class="searchBarPrivate" action="shipsPrivateSideSearchByName.php" method="GET">
                    <i class="fa-solid fa-magnifying-glass" id="searchIcon"></i>
                    <input type="text" name="keyword" class="searchInput" placeholder="Search Ship...." required <?php echo "value=$keyword "; ?> >
                 </form>
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchShipPrivatecSide($dbConnect, $keyword, $succesfullSearch) ?>
