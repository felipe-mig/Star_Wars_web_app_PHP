...
updateForce($dbConnect,$id, $about, $imageone, $imagetwo);

$updateForce = updateForce($dbConnect,$id, $about, $imageone, $imagetwo);
...
<body>
            ...
            <?php if ($updateForce){ 
                ...
                echo '   
                    <div class="UpdateSuccessMessageContainer">
                        ...
                        <p class="updateSuccesP">The Force has been succesfully updated</p>
                    </div>
                ';
            } 
    ...
    <script>
        function bounce(){
            window.location.href = "theForce.php"
        }
