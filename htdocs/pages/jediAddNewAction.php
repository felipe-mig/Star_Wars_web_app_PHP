...
$insertJedi = insertJedi($dbConnect, $name, $lightsaber, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo)
...
<body onload="bounce()">
    ...
    <script>
        ...
        function bounce(){
            window.location.href = "jedisPrivateSide.php#iconAdd"
        }
