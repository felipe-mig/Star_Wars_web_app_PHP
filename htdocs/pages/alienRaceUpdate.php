...
$id = $_GET['id'];
$name = returnAlienDetails($dbConnect, $id, 'name');
$bio = returnAlienDetails($dbConnect, $id, 'bio');
$episodeiv = returnAlienDetails($dbConnect, $id, 'episodeiv');
$episodev = returnAlienDetails($dbConnect, $id, 'episodev');
$episodevi = returnAlienDetails($dbConnect, $id, 'episodevi');
$thumbernail = returnAlienDetails($dbConnect, $id, 'thumbernail');
$imageone = returnAlienDetails($dbConnect, $id, 'imageone');
$imagetwo = returnAlienDetails($dbConnect, $id, 'imagetwo');
...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <form class="formDetailsMainContainer" action="alienRaceUpdateAction.php" method="POST">
                    <div class="updateSlideshowContainer">
                        <input type="hidden" name="id" value="<?php echo $id ?>">

                        <div class="updateImageThumbernailContainer">
                            <img class="updateImageThumbernail" src="../images/alienraces/<?php echo $thumbernail; ?>" alt="thumbernail">
                        ...
                        <div class="updateImageSlideOneContainer">
                            <img class="updateImageSlideOne" src="../images/alienraces/<?php echo $imageone; ?>" alt="image1">
                        ...
                        <div class="updateImageSlideTwoContainer">
                            <img class="updateImageSlideTwo" src="../images/alienraces/<?php echo $imagetwo; ?>" alt="image2">
                    ...
                    <div class="updateConfirmButtonsContainer">
                        <a href="alienRacesPrivateSide.php"><div class="updateCancelButton">Cancel</div></a>
