...
updatePlanet($dbConnect, $id, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);

$updatePlanet = updatePlanet($dbConnect, $id, $name, $bio, $episodeiv, $episodev, $episodevi, $thumbernail, $imageone, $imagetwo);
...
<body>
    ...
    <script>
        function bounce(){
            window.location.href = "planetsPrivateSide.php"
        }
