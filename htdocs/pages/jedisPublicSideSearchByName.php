...
<body>
    ...
    <div class="wrapper"> 
        ...
        <div class="mainRightContainer">
                ...
                <!-- Search Bar -->
                <form class="searchBar" action="jedisPublicSideSearchByName.php" method="GET">
                ...
                <div class="dataDisplayMainContainer">
                    ...
                    <?php searchJediPublicSide($dbConnect, $keyword, $succesfullSearch) ?>
